...
export const introToProgramming: Topic = {
  ...
  description:
    'Before you write your first line of C, you need to understand what programming actually is — not just the syntax, but the way of thinking. Programming is the art of breaking a problem into steps so precise that even a machine with no common sense can follow them. This topic introduces that way of thinking, from your very first "Hello, World!" to the structured process of designing algorithms before touching the keyboard.',
  difficulty: 'beginner',
  prerequisites: [],
  estimatedMinutes: 45,
  ...
  subtopics: [
    {
      ...
      description:
        'A computer is extraordinarily fast but has absolutely no judgment — it cannot guess what you meant, fill in missing details, or improvise when your instructions are unclear. A program is your way of communicating with this powerful but literal machine: a precise, unambiguous sequence of instructions that leaves nothing to interpretation. Understanding this fundamental nature of programs — that they are recipes written for a reader with zero common sense but infinite patience — is the first step toward thinking like a programmer.',
      keyPoints: [
    ...
    },
    {
      ...
      description:
        'Writing code is actually the last step of programming, not the first. Before you type a single line of C, you should have a clear algorithm — a step-by-step plan that describes exactly how to solve the problem, written in plain language that anyone could follow. Flowcharts give you a visual way to sketch this plan, using standardized symbols that make the logic visible at a glance. Developing this habit of planning before coding is what separates students who debug for hours from students who get their programs right on the first or second try.',
      keyPoints: [

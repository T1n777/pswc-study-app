  ...
  subtopics: [
    {
      ...
      description: 'The smallest addressable unit of memory in C is a single byte (8 bits). If you only need to store a boolean state (0 or 1), a standard `char` wastes 87.5% of the memory footprint. Bit fields shatter this limitation, allowing you to explicitly declare exactly how many bits a struct member is permitted to consume.',
      keyPoints: [
    ...
    },
    {
      ...
      description: 'Bit fields are incredibly powerful, but they harbor dark corners of the C specification regarding signedness and cross-platform compilation.',
      keyPoints: [

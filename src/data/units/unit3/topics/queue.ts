  ...
  subtopics: [
    {
      ...
      slug: 'queue-fifo',
      description: 'While a Stack enforces LIFO (Last-In, First-Out), a Queue mathematically enforces FIFO (First-In, First-Out). The very first item inserted into the structure is strictly guaranteed to be the first item retrieved.',
      keyPoints: [
    ...
    },
    {
      ...
      slug: 'circular-queue',
      description: 'In extreme-performance systems (like OS network drivers), `malloc` is too slow. We must implement Queues using pre-allocated, fixed-size Arrays. To solve the O(N) array shifting problem, we mathematically bend the array into a ring using the Modulo (`%`) operator.',
      keyPoints: [

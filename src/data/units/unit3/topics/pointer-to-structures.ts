  ...
  subtopics: [
    {
      ...
      slug: 'arrow-operator',
      description: 'C structs can easily exceed thousands of bytes in size. Passing a massive struct to a function "by value" forces the CPU to physically clone every single byte onto the Stack, instantly killing performance. Pointers offer an elegant architectural solution: pass a tiny 8-byte memory address pointing to the original structure.',
      keyPoints: [
    ...
    },
    {
      ...
      description: 'While Stack-allocated structs are inherently temporary (destroyed upon function return), you can combine `malloc` and structs to construct complex data objects on the Heap. This dynamic memory persistence is the exact mechanism that powers Linked Lists, Trees, and Graph data structures.',
      keyPoints: [

  ...
  subtopics: [
    {
      ...
      description: 'C code is technically processed twice: first by the Preprocessor, then by the Compiler. The `#pragma` directive is the official C-standard mechanism for a programmer to pass meta-instructions directly to the compiler\'s internal engine, fundamentally altering how it builds the binary executable.',
      keyPoints: [
    ...
    },
    {
      ...
      slug: 'pragma-pack',
      description: 'The most powerful—and dangerous—use of `#pragma` in systems engineering is manually overriding the compiler\'s hardware memory alignment rules, specifically regarding structural padding.',
      keyPoints: [

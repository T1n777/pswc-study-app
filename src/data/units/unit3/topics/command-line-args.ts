  ...
  subtopics: [
    {
      ...
      slug: 'argc-and-argv',
      description: 'When you execute a program via the terminal (like `gcc main.c -Wall`), the `main` function does not start with an empty state. The Operating System intercepts the raw text of your terminal command, breaks it apart into individual strings, allocates memory for them, and mathematically passes them into `main`. This is the foundational mechanism for building professional CLI (Command Line Interface) utilities.',
      keyPoints: [
    ...
    },
    {
      ...
      description: 'The OS passes ALL command line arguments as raw text strings. Even if you type `42`, the OS delivers the ASCII byte array `[\'4\', \'2\', \'\\0\']`. Before your CPU can perform mathematical operations, you must explicitly route these strings through parsing architecture to reconstruct the binary integers or floats.',
      keyPoints: [

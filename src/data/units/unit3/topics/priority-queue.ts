  ...
  subtopics: [
    {
      ...
      description: 'In a mathematically pure FIFO Queue, execution is strictly chronological. In a Priority Queue, every data payload is permanently coupled with a numeric `priority` tag. The data structure physically reorders itself (or mathematically searches) to guarantee that the highest priority element is always extracted next, shattering chronological order.',
      keyPoints: [

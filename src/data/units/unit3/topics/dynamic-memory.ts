  ...
  subtopics: [
    {
      ...
      slug: 'stack-vs-heap',
      description: 'Before you can safely allocate memory, you must understand the two fundamentally different memory architectures your program uses at runtime: The Stack (automatic memory) and The Heap (manual memory).',
      keyPoints: [
    ...
    },
    {
      ...
      description: 'To harness the power of the Heap, you must master the holy trinity of dynamic memory functions found inside `<stdlib.h>`: allocation, initialization, and destruction.',
      keyPoints: [
    ...
    },
    {
      ...
      slug: 'memory-bugs',
      description: 'With great power comes absolute responsibility. Because C trusts you implicitly with manual memory management, it exposes you to terrifying vulnerability categories that are literally impossible to create in higher-level languages.',
      keyPoints: [

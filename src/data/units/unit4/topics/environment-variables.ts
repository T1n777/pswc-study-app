...
export const environmentVariables: Topic = {
  ...
  description: 'How C programs communicate with the Operating System to read configuration settings like PATH, HOME, and USER without using files.',
  ...
  subtopics: [
    {
      ...
      description: 'The OS maintains a dictionary of Key-Value strings called Environment Variables. Your C program can read these to adjust its behavior based on the computer it is running on.',
      keyPoints: [
    ...
    },
    {
      ...
      slug: 'setenv-envp',
      description: "You can change environment variables for the duration of your program, and you can access the entire environment block through the secret third argument of main.",
      keyPoints: [

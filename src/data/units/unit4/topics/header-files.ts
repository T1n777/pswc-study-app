...
export const headerFiles: Topic = {
  ...
  title: 'Header Files',
  slug: 'header-files',
  description: "How to split your C program across multiple files using .h files to share function declarations and structures cleanly.",
  ...
  subtopics: [
    {
      ...
      description: "As programs grow, putting everything in one .c file becomes impossible to manage. We split code into modules. Header files (.h) are the \"glue\" that connects multiple .c files together.",
      keyPoints: [
    ...
    },
    {
      ...
      slug: 'include-guards',
      description: "If a.h includes b.h, and main.c includes both a.h and b.h, then b.h gets copied into main.c TWICE. This causes \"Redefinition of struct\" errors. Include guards prevent this.",
      keyPoints: [
